package com.example.asignaturas.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .csrf(csrf -> csrf.ignoringRequestMatchers("/asignaturas/**"))  // Ignorar CSRF en /asignaturas
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests
                                .requestMatchers("/asignaturas/**").authenticated()  // Requiere autenticación para /asignaturas
